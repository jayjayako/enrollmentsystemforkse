...
////////////////// checking admission module //////////////////
function registrarmodule(req, res, next) {
  let sql =
    "SELECT edit_enrollee_rec FROM registrar_module WHERE edit_enrollee_rec=? AND id=?";
  db.query(
    sql,
...
//////////////////////////////////// approve new student //////////////////////////////////
router.get("/approvenewstudent", checkstudent, approvestudent, (req, res) => {
