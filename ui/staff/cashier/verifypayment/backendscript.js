...
async function displayclickabletableverifypayment(superid) {
  let response = await fetch(
    "/api/staff/cashier/verifypayment/displayspecifictable?superid=" + superid,
    {
      method: "GET",
    }
  );
...
async function displayalltotalpaymentverifypayment(superid) {
  let response = await fetch(
    "/api/staff/cashier/verifypayment/displayallpayment?superid=" + superid,
    {
      method: "GET",
    }
  );
...
function verifypaymentfunc(options) {
  async function displayschoollevel() {
    ...
    let response1 = await fetch(
      "/api/staff/cashier/verifypayment/displayschoollevel",
      {
        method: "GET",
      }
    );
  ...
  async function displayyearlevel() {
    ...
    //////// get school level data /////
    let response1 = await fetch(
      "/api/staff/cashier/verifypayment/displayyearlevel?schoollevel=" +
        schoollevel,
      {
        method: "GET",
      }
  ...
  async function displaytable() {
    ...
    let response = await fetch(
      "/api/staff/cashier/verifypayment/displaytable?schoollevel=" +
        schoollevel +
        "&yearlevel=" +
        yearlevel,
      {
  ...
  async function displayidfiltertable() {
    ...
    //////////////////////// get table data //////////////////////
    let response1 = await fetch(
      "/api/staff/cashier/verifypayment/filterbyid?idnumber=" + id,
      {
        method: "GET",
      }
    );
  ...
  async function paynow() {
    ...
    let response = await fetch(
      "/api/staff/cashier/verifypayment/paynow?superid=" +
  ...
  async function approvepayment() {
    let response = await fetch(
      "/api/staff/cashier/verifypayment/approve?superid=" +
        verifypaymentglobalvar,
      {
        method: "GET",
      }
