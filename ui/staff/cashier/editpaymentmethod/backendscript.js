function editpaymentmethodfunc(options) {
  async function displaydropdown() {
    ...
    let response1 = await fetch(
      "/api/staff/cashier/editpaymentmethod/displaypaymentmethod",
      {
        method: "GET",
      }
    );
  ...
  async function displayspecificdropdown() {
    ...
    //////// get payment method dropdown data /////
    let response1 = await fetch(
      "/api/staff/cashier/editpaymentmethod/displayspecificpaymentmethod?paymentmethod=" +
        paymentmethod,
      {
        method: "GET",
      }
  ...
  async function addnewdata() {
    ...
    let response = await fetch(
      "/api/staff/cashier/editpaymentmethod/inserpaymentmethod",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function deletedata() {
    ...
    let response = await fetch(
      "/api/staff/cashier/editpaymentmethod/deletepaymentmethod",
      {
        method: "POST",
        body: formData,
      }
