function paymentplanamount(options) {
  async function loadschoollevel() {
    ...
    let response1 = await fetch(
      "/api/staff/accounting/paymentplanamount/displayschoollevel",
      {
        method: "GET",
      }
    );
  ...
  async function loadyearlevel() {
    ...
    let response2 = await fetch(
      "/api/staff/accounting/paymentplanamount/displayyearlevel?schoollevel=" +
        schoollevel,
      {
        method: "GET",
      }
  ...
  async function loadpaymenttype() {
    ...
    let response2 = await fetch(
      "/api/staff/accounting/paymentplanamount/displaypaymenttype?schoollevel=" +
        schoollevel +
        "&yearlevel=" +
        yearlevel,
      {
  ...
  async function displaytable() {
    ...
    ///////////////////////////// get filter data /////////////////////////////////////////
    let response2 = await fetch(
      "/api/staff/accounting/paymentplanamount/displayspecificpaymentplanamount?schoollevel=" +
        schoollevel +
        "&yearlevel=" +
        yearlevel +
        "&paymenttype=" +
  ...
  async function update() {
    ...
    let response = await fetch(
      "/api/staff/accounting/paymentplanamount/updatepaymentplanamount",
      {
        method: "POST",
        body: formData,
      }
