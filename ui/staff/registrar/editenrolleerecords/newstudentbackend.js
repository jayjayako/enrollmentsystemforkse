...
async function editenrolleerecordsnewstudentdisplaystudentinfo(studentid) {
  let response = await fetch(
    "/api/staff/registrar/admission/displaynewstudentfiles?studentid=" +
      studentid,
    {
      method: "GET",
    }
  ...
  let response2 = await fetch(
    "/api/staff/registrar/admission/displayspecificnewstudent?studentid=" +
      studentid,
    {
      method: "GET",
    }
...
function editenrolleerecordsnewstudent(options) {
  ...
  async function displaystudenttable() {
    let response = await fetch(
      "/api/staff/registrar/admission/displaynewstudent",
      {
        method: "GET",
      }
    );
  ...
  async function approvestudent() {
    ...
    let response = await fetch(
      "/api/staff/registrar/admission/approvenewstudent?studentid=" + studentid,
      {
        method: "GET",
      }
    );
