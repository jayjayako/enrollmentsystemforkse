...
async function loadalldropdownsection() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/section/displayschoollevel",
    {
      method: "GET",
    }
  );
  ...
  let response2 = await fetch(
    "/api/staff/registrar/section/displayyearlevel?schoollevel=" + schoollevel,
    {
      method: "GET",
    }
  );
  ...
  let response3 = await fetch(
    "/api/staff/registrar/section/displaysection?schoollevel=" +
      schoollevel +
      "&yearlevel=" +
      yearlevel,
    {
...
async function savesection() {
  ...
  let response = await fetch("/api/staff/registrar/section/insertsection", {
    method: "POST",
    body: formData,
  });
...
async function deletesection() {
  ...
  let response = await fetch("/api/staff/registrar/section/deletesection", {
    method: "POST",
    body: formData,
  });
  let myresult = await response.json();
