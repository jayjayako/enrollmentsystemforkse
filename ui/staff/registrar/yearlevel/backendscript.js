...
async function loadalldropdownyearlevel() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/yearlevel/displayschoollevel",
    {
      method: "GET",
    }
  );
  ...
  let response2 = await fetch(
    "/api/staff/registrar/yearlevel/displayyearlevel?schoollevel=" +
      schoollevel,
    {
      method: "GET",
    }
...
async function saveyearlevel() {
  ...
  let response = await fetch("/api/staff/registrar/yearlevel/insertyearlevel", {
    method: "POST",
    body: formData,
  });
...
async function deleteyearlevel() {
  ...
  let response = await fetch("/api/staff/registrar/yearlevel/deleteyearlevel", {
    method: "POST",
    body: formData,
  });
  let myresult = await response.json();
