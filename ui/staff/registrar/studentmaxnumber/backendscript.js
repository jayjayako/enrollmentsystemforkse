...
async function displaystudentmaxnum() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/studentmaxnum/displaystdntmaxnumber",
    {
      method: "GET",
    }
  );
  ...
  let response2 = await fetch(
    "/api/staff/registrar/studentmaxnum/displayclassmaxnumber",
    {
      method: "GET",
    }
  );
...
async function updatestudentmaxnum() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/studentmaxnum/updatestdntmaxnumber",
    {
      method: "POST",
      body: formData,
    }
...
async function updateclassmaxnum() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/studentmaxnum/updateclassmaxnumber",
    {
      method: "POST",
      body: formData,
    }
