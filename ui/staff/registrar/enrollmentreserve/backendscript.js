...
async function displayenrollmentreserveclickabletable(superid) {
  let response = await fetch(
    "/api/staff/registrar/enrollmentreservation/displayspecificinfo?superid=" +
      superid,
    {
      method: "GET",
    }
...
function enrollmentreservationfunction(options) {
  async function loadtable() {
    ...
    let response = await fetch(
      "/api/staff/registrar/enrollmentreservation/displaytable",
      {
        method: "GET",
      }
    );
  ...
  async function approvereserve() {
    let response = await fetch(
      "/api/staff/registrar/enrollmentreservation/approve?superid=" +
  ...
  async function deletereserve() {
    let response = await fetch(
      "/api/staff/registrar/enrollmentreservation/deletereserve?superid=" +
        studentsuperidglobalvar,
      {
        method: "GET",
      }
