...
async function loadalldropdown() {
  ...
  let response1 = await fetch(
    "/api/staff/registrar/enrollmentschedule/displaymonth",
    {
      method: "GET",
    }
  );
  ...
  if (myresult1) {
    ...
    let response2 = await fetch(
      "/api/staff/registrar/enrollmentschedule/displaydays?month=" + month1,
      {
        method: "GET",
      }
    );
    ...
    let response3 = await fetch(
      "/api/staff/registrar/enrollmentschedule/displaydays?month=" + month2,
      {
        method: "GET",
      }
    );
    ...
    let response4 = await fetch(
      "/api/staff/registrar/enrollmentschedule/displaycursched",
      {
        method: "GET",
      }
    );
...
async function save() {
  ...
  let response = await fetch(
    "/api/staff/registrar/enrollmentschedule/updateschedule",
    {
      method: "POST",
      body: formData,
    }
