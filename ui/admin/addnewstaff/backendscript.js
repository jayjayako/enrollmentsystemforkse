...
async function displayclickabletableaddnewstaff(id) {
  ...
  let response = await fetch(
    "/api/admin/addnewstaff/displayspecificuser?id=" + id,
    {
      method: "GET",
    }
  );
...
function addstafffunc(options) {
  function addnewstaffmodule() {
    try {
      ...
      setTimeout(addnewstaffmodule, 1000);
    }
  }
  ...
  async function displaystaffposition() {
    try {
      let response = await fetch(
        "/api/admin/addnewstaff/displaystaffposition",
        {
          method: "GET",
        }
      );
  ...
  async function addstaffnow() {
    ...
    let response = await fetch("/api/admin/addnewstaff/addnewstaff", {
      method: "POST",
      body: formData,
    });
    let myresult = await response.json();
  ...
  async function displaytable() {
    ...
    let response = await fetch("/api/admin/addnewstaff/displaytable", {
      method: "GET",
    });
    let myresult = await response.json();
    if (myresult[0].id != "invalid") {
  ...
  async function getnewpassword() {
    let response = await fetch("/api/admin/addnewstaff/getnewpassword", {
      method: "GET",
    });
    let myresult = await response.json();
    if (myresult[0].id != "invalid") {
  ...
  async function updatestaff() {
    ...
    formData.append("staffmodule8", staffmodule8);
    let response = await fetch(
      "/api/admin/addnewstaff/updatestaff?id=" + addstaffglobalvarid,
      {
        method: "POST",
        body: formData,
      }
  ...
  async function deletestaff() {
    let response = await fetch(
      "/api/admin/addnewstaff/deletestaff?id=" + addstaffglobalvarid,
      {
        method: "GET",
      }
    );
