...
async function displayclickabletablerestorestudent(superid) {
  ...
  let response = await fetch(
    "/api/admin/managestudent/displayspecificdata?superid=" + superid,
    {
      method: "GET",
    }
  );
...
var addnewstaffglobalvar,
  ...
  audittrailglobalvar,
  viewreportglobalvar;
function managestudentfunct(options) {
  var myresult;
  var myprofilepic;
  ...
  function managestudentmodule() {
    try {
      ...
      setTimeout(managestudentmodule, 1000);
    }
  }
  ...
  async function checkuser() {
    try {
      ...
      if (myresult != "invalid") {
        ...
        managestudentmodule();
        managestudentfunct("getschoollevel");
      } else {
  ...
  async function getschoollevel() {
    try {
      let response = await fetch(
        "/api/admin/managestudent/displayschoollevel",
        {
          method: "GET",
        }
      );
  ...
  async function displaytable() {
    ...
    let response = await fetch(
      "/api/admin/managestudent/displaytable?schoollevel=" + schoollevel,
      {
        method: "GET",
      }
    );
  ...
  async function deletestudent() {
    let response = await fetch(
      "/api/admin/managestudent/deletestudent?superid=" + managestudentsuperid,
      {
        method: "GET",
      }
    );
  ...
  async function displaydeactivatedstudent() {
    ...
    let response = await fetch("/api/admin/managestudent/displaydeactstudent", {
      method: "GET",
    });
    let myresult = await response.json();
    if (myresult[0].id != "invalid") {
  ...
  async function restorenow() {
    let response = await fetch(
      "/api/admin/managestudent/restorestudent?superid=" + managestudentsuperid,
      {
        method: "GET",
      }
    );
