async function loadalldata() {
  await includeHTML();
  setTimeout(viewreportfunc, 300, "checkuser");
...
function tabfunction(evt, tabname) {
  ...
  if (tabname == "tab1") {
    viewreportfunc("viewadminreport");
  }
  if (tabname == "tab2") {
    viewreportfunc("viewstaffposition");
  }
  if (tabname == "tab3") {
    viewreportfunc("getschoollevel");
  }
  if (tabname == "tab4") {
    viewreportfunc("viewstudentpayments");
  }
  if (tabname == "tab5") {
    viewreportfunc("getactivitylogusertype");
  }
  if (tabname == "tab6") {
    viewreportfunc("getloghistoryusertype");
  }
}
/////////////////////////////////////
function preload() {
