function paymentplans(options) {
  ...
  async function displaydropdownmonth() {
    ...
    //////////////////////////////// get month data ////////////////////////////////////
    let response1 = await fetch(
      "/api/superadmin/accounting/paymentplans/displaymonth?year=" + year,
      {
        method: "GET",
      }
    );
  ...
  async function displaydropdownday() {
    ...
    /////////////////////////////// get day data /////////////////////////////////////
    let response1 = await fetch(
      "/api/superadmin/accounting/paymentplans/displayday?month=" +
        month +
        "&year=" +
        year,
      {
  ...
  async function displaytable() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/paymentplans/displayspecificpaymentplans?schoollevel=" +
        schoollevel +
        "&yearlevel=" +
        yearlevel,
      {
  ...
  async function addnewdata() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/paymentplans/insertpaymentplans",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function updatedata() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/paymentplans/updatepaymentplans",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function deletedata() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/paymentplans/deletepaymentplans",
      {
        method: "POST",
        body: formData,
      }
