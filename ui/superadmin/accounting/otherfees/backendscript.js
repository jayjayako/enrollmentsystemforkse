function otherfeesfunc(options) {
  ...
  async function displayotherfeestable() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/otherfees/displayspecificotherfees?schoollevel=" +
        schoollevel +
        "&yearlevel=" +
        yearlevel,
      {
  ...
  async function addnewotherfees() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/otherfees/insertotherfees",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function updateotherfees() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/otherfees/updateotherfees",
      {
        method: "POST",
        body: formData,
      }
  ...
  async function deleteotherfees() {
    ...
    let response = await fetch(
      "/api/superadmin/accounting/otherfees/deleteotherfees",
      {
        method: "POST",
        body: formData,
      }
